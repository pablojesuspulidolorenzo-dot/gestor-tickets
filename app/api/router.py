...
from app.api.routes import accounts, auth, glpi_tickets, health, mail_ingestion, mailbox, threads
...
api_router.include_router(mail_ingestion.router, prefix="/mail-ingestion")
